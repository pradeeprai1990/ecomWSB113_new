...
export function Card({data,path}) {
  ...
  return (
    <div className='cursor-pointer group'>
                <div className=' w-full h-full'>
                    ...
                    <img className='h-full w-full object-cover' src={path+data.productImage} alt="Womens Denim" />


                    <img className='h-full w-full duration-300 z-[999] absolute top-0 group-hover:block hidden object-cover' src={path+data.productAnimationImage} alt="Womens Denim" />
                ...
                <h5 className='sm:text-[14px] text-[12px] flex gap-3 mt-2 font-semibold'>{data.productName}
                ...
                <div className='sm:text-[14px] text-[13px] font-medium mt-1 sm:mt-3'>${data.productMRP}</div>
